...
import javax.swing.JPanel;
	...
	public class MazeDisplay extends JPanel implements Printable, ActionListener, KeyListener
	{
	  ...
	  Integer movehist = moveCounter;
	  Integer moveCounter2 = 0;
	  Integer movehist2 = moveCounter2;
	  ...
	  public int print(Graphics g, PageFormat pf, int page)
		...
		private void doDrawing(Graphics g)
		{
			...
			g2d.drawString("Blue Player", m1.sizeX * cellSize + offsetX + 20, 20);
			g2d.drawString("Moves:" + moveCounter.toString(), m1.sizeX * cellSize + offsetX + 20, 40);
			g2d.drawString("Move: Arrow Keys", m1.sizeX * cellSize + offsetX + 20, 60);
		...
		int x2, y2;
			...
			g2d.drawString("Red Player", m1.sizeX * cellSize + offsetX + 20, 120);
			g2d.drawString("Moves:" + moveCounter2.toString(), m1.sizeX * cellSize + offsetX + 20, 140);
			g2d.drawString("Move: WASD", m1.sizeX * cellSize + offsetX + 20, 160);
		...
		{
			if(moveCounter != movehist)
			{
			oldX = pointX;
			oldY = pointY;
			movehist = moveCounter;
			}
			...
			if(moveCounter2 != movehist2)
			{
			oldX2 = pointX2;
			oldY2 = pointY2;
			movehist2 = moveCounter2;
			}
